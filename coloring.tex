...
\\
abac & ba\dots \to ac\dots \\
acab & ca\dots \to ab\dots \\
babc & ab\dots \to bc\dots \\
bcba & cb\dots \to ba\dots \\
cacb & ac\dots \to cb\dots \\
cbca & bc\dots \to ca\dots \\
\\
abcb & ab\dots \to bc\dots \\
acbc & ac\dots \to cb\dots \\
baca & ba\dots \to ac\dots \\
bcac & bc\dots \to ca\dots \\
caba & ca\dots \to ab\dots \\
cbab & cb\dots \to ba\dots \\
\\
abcc & ab(c\dots) \\
acbb & ac(b\dots) \\
bacc & ba(c\dots) \\
...
bacbac & bac\dots \\
\\
abcabb & cab\dots \to ca(b\dots) \\
acbacc & bac\dots \to ba(c\dots) \\
bacbaa & cba\dots \to cb(a\dots) \\
bcabcc & abc\dots \to ab(c\dots) \\
cabcaa & bca\dots \to bc(a\dots) \\
cbacbb & acb\dots \to ac(b\dots) \\
\\
cabcc & abc\dots \to ab(c\dots) \\
bacbb & acb\dots \to ac(b\dots) \\
cbacc & bac\dots \to ba(c\dots) \\
abcaa & bca\dots \to bc(a\dots) \\
bcabb & cab\dots \to ca(b\dots) \\
acbaa & cba\dots \to cb(a\dots) \\
\\
abcaba & cab\dots \to c(ab\dots) \\
acbaca & bac\dots \to b(ac\dots) \\
bacbab & cba\dots \to c(ba\dots) \\
bcabcb & abc\dots \to a(bc\dots) \\
cabcac & bca\dots \to b(ca\dots) \\
cbacbc & acb\dots \to a(cb\dots) \\
\\
abcaca & bca\dots \to b(ca\dots) \\
acbaba & cba\dots \to c(ba\dots) \\
bacbcb & acb\dots \to a(cb\dots) \\
bcabab & cab\dots \to c(ab\dots) \\
cabcbc & abc\dots \to a(bc\dots) \\
cbacac & bac\dots \to b(ac\dots) \\
\end{array}
\]
