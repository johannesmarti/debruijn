...
\begin{tikzpicture}
 ...
 \draw [->] (a) edge [bend left=15] node[above] {$0,1$} (c);
 \draw [->] (c) edge [bend left=15] node[below] {$0,1$} (a);

 \draw [->] (c) edge [bend left=15] node[above] {$0,1$} (b);
 \draw [->] (b) edge [bend left=15] node[below] {$0,1$} (c);
